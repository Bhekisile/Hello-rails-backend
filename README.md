...
**[Hello Rails backend]** is a backend API for the Hello-React-frontend web application project. A rails-based backend solution to storing greeting messages for the web application.
...
```sh
  cd my-folder
  git clone git@github.com:Bhekisile/Hello-rails-backend.git
```
